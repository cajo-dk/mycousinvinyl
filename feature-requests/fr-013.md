...
- Sort descending by YTD play count, then by album title (stable tie-breaker).
- List columns:
  - `#` (1..n)
...
- List is ordered by YTD play count descending and supports pagination (default 50).
